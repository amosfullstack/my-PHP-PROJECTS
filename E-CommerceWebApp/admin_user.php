...
<body>
    ...
    <section class="message-container">
        <h1 class="title" style="text-align: center;"> total user account</h1>
        <div class="box-container">
            ...
            <div class="box">
                ...
                <a href="admin_user.php?delete=<?php echo $fetch_users['id']; ?>;" onclick="return comfirm('delete this message');" class="delete">delete</a>
            </div>
            <?php
                    } 
